...
<body>
	...
	<div class="container-fluid bookdetails1">
		<div class="row pt-4">
			...
			<div class="col-sm-6 pl-4">
        <h3 class="mb-4 ml-3 pl-4">My Addresses:</h3>
        <ul>
          <?php
            ...
            while($row = $result->fetch_assoc()){
              echo "<li class='mb-3 h5 pl-3 pt-2 pb-2 bg-rounded bg-light text-secondary'>".$row['name']."<br>".$row['addr1']."\t".$row['addr2']."\t".$row['addr3']."<br>PIN: ".$row['pin']." , ".$row['city'].", ".$row['district'].", ".$row['state']."<br>Contact: ".$row['contact']."</li>";
            }
          ?>
        </ul>
			</div>
